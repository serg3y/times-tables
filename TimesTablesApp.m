...
classdef TimesTablesApp < handle
    ...
    methods
        ...
        function createSettingsPanel(obj)
            ...
            uicontrol(h, 'Style', 'chec', 'Position', [0.35 0.9 0.3 0.07], 'String', 'Times',  'Value', ismember("Times", obj.Operators),  'Callback', @(o, ~)setOperators('Times',  o.Value))
            uicontrol(h, 'Style', 'chec', 'Position', [0.65 0.9 0.3 0.07], 'String', 'Divide', 'Value', ismember("Divide", obj.Operators), 'Callback', @(o, ~)setOperators('Divide', o.Value));
            uicontrol(h, 'Style', 'edit', 'Position', [0.3 0.8 0.65 0.07], 'String', mat2str(obj.Numbers1), 'Callback', @(o, ~)setVal('Numbers1', str2num(o.String, 'Evaluation', 'restricted'))); %#ok<ST2NM>
            uicontrol(h, 'Style', 'edit', 'Position', [0.3 0.7 0.65 0.07], 'String', mat2str(obj.Numbers2), 'Callback', @(o, ~)setVal('Numbers2', str2num(o.String, 'Evaluation', 'restricted'))); %#ok<ST2NM>
            uicontrol(h, 'Style', 'edit', 'Position', [0.3 0.5 0.40 0.07], 'String', obj.MaxTime,  'Callback', @(o, ~)setVal('MaxTime',  str2double(o.String)), 'Tooltip', 'Maximum time per question (sec)');
            uicontrol(h, 'Style', 'edit', 'Position', [0.3 0.4 0.40 0.07], 'String', obj.MaxCount, 'Callback', @(o, ~)setVal('MaxCount', str2double(o.String)), 'Tooltip', 'Limit assessment to this many results');
            uicontrol(h, 'Style', 'edit', 'Position', [0.3 0.3 0.40 0.07], 'String', obj.Gamma,    'Callback', @(o, ~)setVal('Gamma',    str2double(o.String)), 'Tooltip', 'Selectivity');
        ...
        function createQuizPanel(obj)
            ...
            obj.ResponceH = uicontrol(h, 'Style', 'edit', 'Position', [0.2 0.5 0.6 0.1], 'FontSize', 36, 'KeyPressFcn', @responceCallback);
        ...
        function plotResults(obj, ax, operator)
            ...
            plotmatrix(ax, obj.Numbers1, obj.Numbers2, Time, Count, Count) 
            % plotmatrix(ax, obj.Numbers1, obj.Numbers2, Time, Count, string(Time) + newline + string(Count) + newline + string(Prob)) % Debug
